...
class TextInput:
    def __init__(self, x, y, w, h, font, text_color=pygame.Color("white"),
                  color_inactive=pygame.Color("lightskyblue3", ),color_active=pygame.Color("dodgerblue2"), cursor_interval=500, max_length=None, placeholder="", bg_color=pygame.Color("black")):
